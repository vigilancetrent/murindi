...
Murindi is a **local-first, self-hosted quantitative trading system**.
...
Murindi is under active development.
...
or commit when running Murindi in production environments.

---

## 🧠 Security Model & Scope

Murindi is designed to run **entirely under the user’s control**.

### In Scope
We consider the following areas in scope for security review:

- Source code vulnerabilities in this repository
- Authentication and authorization logic within Murindi
...
- Modified or unofficial builds of Murindi

---

## 📣 Reporting a Vulnerability

If you believe you have found a security vulnerability in Murindi,
...
Murindi is provided **as-is**, without warranty.
...
Thank you for helping keep Murindi safe.
