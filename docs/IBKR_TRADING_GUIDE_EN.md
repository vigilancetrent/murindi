...
Murindi supports US stocks live trading via Interactive Brokers TWS or IB Gateway.
...
| **Port** | TWS/Gateway API port | `7496` (TWS Live), `7497` (TWS Paper) |
...
When running Murindi in Docker, TWS/IB Gateway must be accessible from the container:
