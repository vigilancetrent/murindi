...
> Murindi supports strategy signal notifications via email, ideal for users who need detailed notification records.
...
- Murindi backend service deployed and running

---

## Supported Email Providers

Murindi supports any standard SMTP protocol email provider, including:
...
Yes, Murindi automatically sends formatted HTML emails with a plain text fallback for maximum compatibility.
