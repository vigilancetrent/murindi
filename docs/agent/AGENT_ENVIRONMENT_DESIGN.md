# Murindi — Multi-Agent Runtime Environments (Design)
...
| Repository | [Murindi](https://github.com/vigilancetrent/Murindi) — self-hosted quant stack: research, strategies, backtests, live trading |
...
- [x] `.cursor/skills/murindi-agent-workflow/` — project Cursor skill (English) pointing agents here.
