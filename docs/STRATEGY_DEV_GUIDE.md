# Murindi v3 Python Strategy Development Guide
...
Murindi currently supports two Python authoring models:
...
This version is closer to how developers actually use Murindi today:
