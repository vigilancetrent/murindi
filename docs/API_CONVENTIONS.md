# Murindi API conventions (OpenAPI SSOT)

This document defines the **contract rules** for Murindi HTTP APIs.
...
- Used by the Murindi web/mobile UI.
...
| **Internal** | `x-visibility: internal` | Murindi product; may change without notice |
