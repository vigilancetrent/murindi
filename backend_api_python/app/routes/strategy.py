...
def ai_generate_strategy():
    ...
    try:
        ...
        if intent == 'bot_recommend':
            ...
            # USStock and Forex on Murindi are always spot; lock it so
...
"""
        ...
        def _repair_strategy_code_via_llm(bad_code: str, validation: dict) -> str:
            repair_prompt = (
                "You produced Murindi strategy script code that failed automatic validation. "
                ...
                "- Must compile and run in Murindi strategy runtime.\n"
