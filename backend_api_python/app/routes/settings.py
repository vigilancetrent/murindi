...
ADVANCED_KEYS = {
    ...
    'AGENT_JOBS_MAX_WORKERS', 'AGENT_LIVE_TRADING_ENABLED', 'MURINDI_DEPLOYMENT_MODE',
    ...
    'brand': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'default': '© 2025-2026 Murindi. All rights reserved.',
    ...
    'contact': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'default': 'https://github.com/vigilancetrent/murindi/issues',
        ...
        'items': [
            {
                ...
                'label': 'Secret Key',
                'type': 'password',
                'default': 'murindi-secret-key-change-me',
    ...
    'security': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'required': False,
                'description': 'Comma-separated scheme+host (+ optional port) of additional frontends allowed as OAuth post-login redirect targets, e.g. https://m.murindi.com,https://app.murindi.com. FRONTEND_URL is always allowed implicitly.'
            },
            {
...
_BRAND_DEFAULTS = {
    'app_name': 'Murindi',
    'copyright': '© 2025-2026 Murindi. All rights reserved.',
    'contact_email': 'support@murindi.com',
    'contact_support_url': '',
    'contact_feature_request_url': 'https://github.com/vigilancetrent/murindi/issues',
    'contact_live_chat_url': '',
    'social_github': 'https://github.com/vigilancetrent/murindi',
    'social_x': '',
    'social_discord': '',
    'social_telegram': '',
    'social_youtube': '',
...
def get_brand_config():
    ...
    Empty ENV values fall back to the bundled Murindi defaults so a fresh
