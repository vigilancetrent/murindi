...
exchange / market / contract type / direction / bot strategy Murindi
...
ways in:
  ...
  - Murindi-Vue-src/src/views/trading-assistant/index.vue (UI guard)
  - Murindi-Vue-src/src/views/trading-bot/components/BotCreateWizard.vue (bot guard)
...
# Brokers whose live execution path in Murindi only supports long-only
...
def validate_strategy_config(
    *,
    ...
    if ex in LONG_ONLY_BROKERS and td and td != "long":
        raise ValueError(
            f"{ex.upper()} live execution in Murindi is currently "
