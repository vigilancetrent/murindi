...
Murindi timeframes are mapped to the closest ISS interval.
"""
...
# Murindi timeframe -> MOEX ISS candle interval (minutes; 24=day, 7=week, 31=month)
...
class MOEXDataSource(BaseDataSource):
    ...
    def __init__(self, board: str = DEFAULT_BOARD):
        ...
        self._session.headers.update({"User-Agent": "Murindi/MOEX-DataSource"})
