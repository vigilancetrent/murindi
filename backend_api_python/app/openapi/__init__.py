"""
OpenAPI / flask-smorest integration for the Murindi human web API.
...
def init_openapi(app: Flask) -> Api:
    ...
    app.config.setdefault("API_TITLE", "Murindi Web API")
    app.config.setdefault("API_VERSION", "1.0.0")
    app.config.setdefault("OPENAPI_VERSION", "3.0.3")
    app.config.setdefault(
        "OPENAPI_DESCRIPTION",
        (
            "Human-facing REST API for Murindi. "
    ...
    app.config.setdefault(
        "API_SPEC_OPTIONS",
        {
            "info": {
                ...
                "contact": {
                    "name": "Murindi",
                    "url": "https://github.com/vigilancetrent/murindi",
                },
                "license": {
    ...
    app.extensions["murindi_openapi_api"] = api
    return api


def get_openapi_api(app: Flask) -> Api | None:
    return app.extensions.get("murindi_openapi_api")
